...
BOOST_INCLUDE_PATH = c:/libraries/boo
BOOST_LIB_PATH = c:/libraries/boo/stage/lib
BDB_INCLUDE_PATH = c:/libraries/db/stage/include
BDB_LIB_PATH = c:/libraries/db/stage/lib
OPENSSL_INCLUDE_PATH = c:/libraries/openssl-1.0.0d/include
OPENSSL_LIB_PATH = c:/libraries/open
MINIUPNPC_INCLUDE_PATH = c:/libraries/mini
MINIUPNPC_LIB_PATH = c:/libraries/mini
BDB_LIB_SUFFIX = -5.3
