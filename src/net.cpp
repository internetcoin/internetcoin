...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "InternetCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"itcoin.com", "seeds.itcoin.com"},
    {"itcoin.org", "seed1.itcoin.org"},
    {"itcoin.org", "seed2.itcoin.org"},
    {"itcoin.com", "tnseeds.itcoin.com"}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. InternetCoin is probably already running."), addrBind.ToString().c_str());
        else
