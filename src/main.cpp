...
unsigned int nStakeTargetSpacing = 1 * 12;
int64 nChainStartTime = 1388385602;
int64 nNextStageTime = 1400220929;
...
static int64 nRewardCoinYearMin = 5 * CENT;
...
const string strMessageMagic = "InternetCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1* 24 * 60 * 60;  // one day//softmax.cn
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in InternetCoin
    bool fStrictPayToScriptHash = true; // Always active in InternetCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "InternetCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "China Daily 30/12/2013 China's   ";
        CTransaction txNew;
        txNew.nTime = nChainStartTime;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(9999) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].SetEmpty();//nValue =5000000000;//
        CBlock block;
        ...
        block.nNonce =0;// 122359;

        if(fTestNet){
            block.nTime = nChainStartTime + 30;
            block.nNonce =0;// 231457;
        }

        //// debug print
        printf("block.GetHash() == %s\n", block.GetHash().ToString().c_str());
        printf("block.hashMerkleRoot == %s\n", block.hashMerkleRoot.ToString().c_str());
        assert(block.hashMerkleRoot ==uint256("0xd0d901488a88fcd115b0c41218b45e0aa63b1fa90f36d313f5b7f8edc59c6e65"));// uint256("0xe648665ed998ec960b6fb2e4045434bb5b44cc5b7ae1f47812b7f32884e8555e"));
        block.print();
        assert(block.GetHash() == hashGenesisBlock);//  assert(block.GetHash() == hashGenesisBlock);
